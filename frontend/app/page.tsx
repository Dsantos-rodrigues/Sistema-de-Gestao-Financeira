      ...
      <div className="flex flex-col gap-8">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 inline-flex items-center justify-center rounded-lg bg-ink-900 px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-ink-800 focus:outline-none focus:ring-4 focus:ring-zinc-900/15 disabled:opacity-50"
          >
      ...
      <div className="relative flex flex-col gap-8">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 inline-flex items-center justify-center rounded-lg bg-gold-400 px-4 py-2.5 text-sm font-semibold text-ink-900 transition-colors hover:bg-gold-300 focus:outline-none focus:ring-4 focus:ring-gold-400/30 disabled:opacity-50"
          >
